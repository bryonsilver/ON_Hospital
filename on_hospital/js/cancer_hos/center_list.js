const CENT_LIST = [
    [
        {cate_no:0, 
            ...
            img_src:'', 
            sub_title:[''], 
            sub_context3: ['온종합병원은 간, 담도계 및 췌장내 악성종야에 대해 풍부한 임상경험과 전문지식을 갖춘 소화기내과, 종양내과, 간담췌외과, 방사선종양학과, 영상의학과, 병리과 전문의들이 주축이 되어 전문의들이 모여 진단에서부터 치료까지 환자중심의 유기적인 협조체계를 구축하고 상호 협력함으로서 환자의 빠른 진단 및 환자 개개인에 맞는 최장의 치료를 제공 하고 있습니다.'],
        ...
        {cate_no:0, 
            ...
            num_bold:['간센터 외래(3F)', '간센터 접수/수납(3F)'],
        ...
        {cate_no:0, 
            ...
            sub_context4: ['온 종합병원 대장항문센터는 최소침습수술을 비롯하여 다양한 방법을 통하여 환자들에게 치료의 기회를 제공하고 있습니다.','또한 전문화된 세부 진료과 등의 협진을 통하여 전문적인 치료를 제공하고 있습니다.','특히 고난이도의 수술을 요하는 대장암에서부터 항문질환 등에 이르기까지 빠르고 편안한 진료가 될 수 있도록 노력하고 있습니다. 해당 특수 클리닉과 연계, 치료하여 항문질환 뿐 아니라 항문 질환의 원인에 대한 적절한 치료가 이루어질 수 있도록 하는 역할을 담당하고 있습니다.',],
            sub_context3: ['또한 여러 기능적 직장항문질환도 급격히 그 빈도가 증가하고 있습니다.','이런 상황에서 온 종합병원 대장항문센터는 우수한 대장항문 전문 의료진을 모시고 최첨단 의료장비를 활용하여 최고 수준의 진료를 제공합니다. 같은 질병이라도 환자의 상태에 따라서, 또 같은 환자에게라도 질병의 진행에 따라서 최적의 진료가 다를 수 있습니다.',],
            ...
            sub_context1: ['온 종합병원 대장항문센터는 대장항문질환에 대한 정확한 지식을 전달하고, 상담하며, 환자에 대해서는 최적의 치료를 시행하려고 노력하고 있습니다.',] },
        {cate_no:0, 
            item_no:5, 
            img_src:'5_.jpg', 
        ...
        {cate_no:0, 
            item_no:6, 
            img_src:'page-img4.jpg', 
            sub_title:['소개', '전문클리닉'], 
            sub_context2:['소화기질환(위,식도), 위염, 위궤양, 역류성식도염 등', '췌ㆍ담도질환, 간질환 전문', '위, 대자애시경.용종절제술/소화기 내시경 클리닉'] , 
        ...
        {cate_no:0, 
            item_no:8, 
            img_src:'8_.jpg', 
            sub_title:'신경센터에서 다루는 질환과 증상은 다음과 같습니다.', 
            ...
            sub_context1: ['온 종합병원 신경센터는 뇌와 척수(중추신경), 말초신경 및 근육에 발생하는 질환을 진단하고 치료하며 신경계 질환의 원인을 규명하고 나은 치료방법을 연구하고 있습니다.', '치매클리닉, 간지클리닉, 뇌졸중 클리닉, 말초신경 및 근육질환 클리닉 등 전문 클리닉과 신경심리검사실, 뇌파검사실, 근전도검사실 등 틀수검사실을 운영하여 보다 전문적인 진료와 치료에 최선을 다하고 있습니다.'] },
        {cate_no:0, 
            item_no:9, 
            img_src:'9_.jpg', 
            sub_context9: ['부산 최대 도심 서면에 위치한 온종합병원은 24시간 대기하는 심뇌혈관센터 운영을 통해 골든타임을 다투는 응급환자를 신속하고 편리하게 양질의 응급의료 서비스를 제공하도록 노력하겠습니다.'],
            sub_context8: ['또한, 뇌혈관 질환 조기 발견과 체계적인 관리를 위해 뇌혈관시술 전문의와 심장혈관전문의 최고의 전문수술팀의 협진체제를 구성하여 함께 센터를 운영하고 있습니다.'],
            sub_context7: ['온종합병원 심뇌혈관센터는 미래형 최첨단 혈관수술장비인 필립스사의 바이플랜 안지오(Biplane Angio)를 도입하여 3차원 영상을 통해 미세한 정맥 혈관까지 선명하게 파악할 수 있으며, 검사시간이 짧아 환자에게 투여되는 방사선량도 줄여준다. 팔다리 혈관, 척추 및 척수 혈관 질환, 척추 종양 같은 중추신경계와 두부경 질환까지 치료가 가능합니다.'],
            ...
            sub_context5: ['심뇌혈관센터에서는 내과와 협진을 통해 고혈압, 당뇨병, 흡연 등 뇌졸중의 위험인자를 적극적으로 관리하고, 자기공명영상(MRI)와 자기공명뇌혈관촬영(MRA)등 검사가 이루어지며, 대퇴동맥을 통해 뇌혈관을 검사하는 뇌혈관조영술로 혈관상태를 아주 정확하고 정밀하게 검사하고 중재적 방사선 시술을 통해 치료합니다.'],
            ...
            sub_context3: ['심근경색은 주로 죽상동맥경화가 원인이며 가슴의 흉통으로 시작되고 수분이상 지속 경우가 해당됩니다. 심뇌혈관센터는 흉통을 호소하는 경위는 심전도, 24시간 심전도, 심장초음파, 운동부하검사, CT, MRI 검사 등이 이루어지고 있으며, 관상동맥조영술을 통해 협착 혈관이 발견되면 관상동맥 중재술로 시술이 가능합니다. 급성 응급상황에서는 골든타임(혈관 막힘 후 2시간)내에 막힌 혈관을 뚫는 심혈관성형술, 스텐트삽입술 등 중재술의 빠른 시행이 매우 중요합니다.'],
        ...
        {cate_no:0, 
            item_no:17,
             ...
             sub_context1: ['간암의 경동맥 화학색전술', '다리동맥 협착병', '혈액투석 동정맥루의 혈관성형술', '담즙 배액술', '경피적 위루술, 결피적 신루술', '중심정맥 카테터(POCC,항암포트삽입)', '조직검사(초음파, CT유도하)', '자궁근종 색전술', '전립선 비대증 색전술', '낭ㅈㅇ 경화술', '골반울혈 증후근', '정계 정맥류', '식도, 위, 십이지장 스텐트 삽입술'] },
        {cate_no:0, 
            item_no:18,
        ...
        {cate_no:0, 
            item_no:19,
             ...
             sub_context1: ['재활치료센터는 기능의 장애를 가진 사람들을 평가하고 치료하여, 주어진 조건하에서 이들의 신체적, 정신적, 사회적 능력과 취미, 직업, 교육 등의 잠재적 능력을 최대한 발달시켜 정상에 가까운 생활을 할 수 있게 해 주기 위한 전문치료센터입이다.'] },
        {cate_no:0, 
            item_no:20,
             img_src:'20_.jpg', 
             sub_title:['소개','전문클리닉'], 
        ...
        {cate_no:0, 
            item_no:21,
             img_src:'21_.jpg', 
             sub_title:['전립선암센터', '교수출신 전문 의료진', '홀뮴 야그 레이저 수술기'], 
             check_box:['혈뇨센터', '배뇨장애클리닉', '전립선암'],
             small_title:'특징',
             special:['① 체외 충격파 쇄석술로 잘 제거되지 않는 결석 파괴 제거','② 한번의 시술로 치료 가능','③ 시술 후 회복기간 단축'],
             sub_context1: ['전립선 비대증의 새로운 치료법인 홀렙(HoLEP)수술을 위한 첨단장비인 ㅎ홀뮴야그레이저수술기는 홀렙 시술이 가능한 최신장비로 전립선 비대조직을 제거하는 안전하고 효과적인 장비'] },
        {cate_no:0, 
            item_no:22,
             img_src:'22_.jpg', 
        ...
        {cate_no:0, 
            item_no:25,
             ...
             sub_context3:['온종합병원 턱ㆍ얼굴(악안면)수술센터는 최신의 장비를 이용하여 수술전 분석(2D cephalometry/3D CT/model 분석)을 시행하여 환자 개인에 맞는 최상의 수술계획을 수립하고 있습니다.'],
             sub_context2:['환자중심의 전문센터 One-stop/ One-way(외래/수술준비/입원/수술)시스템 및 턱ㆍ얼굴(악안면)수술환자을 위한 1인실/2인실 입원시스템 그리고 복잡한 과정(접수/대기/반복내원)을 줄여 불편감을 최소로 하였습니다.'],
             sub_context1: ['온종합병원 턱얼굴수술센터는 최고 수준의 진료를 제공하기 위하여 구강악안면외과 의료진을 중심으로 이비인후과 전문의, 마취통증 의학과 전문의 등 체계화된 협진체제로 구성되어 정확한 평가와 치료와 수술 후 최상의 결과를 제공하고 있다.']},
        {cate_no:0, 
            item_no:26,
             img_src:'26_.jpg', 
             sub_title:['', '전문분야'], 
        ...
        {cate_no:0, 
            item_no:27,
             ...
             sub_title:['소개', '전문클리닉'], 
             bold:'항암 방사선 치료',
             sub_context5: ['- 온종합병원 방사선 치료 안내.pdf', '다운로드'],
        ...
        {cate_no:0, 
            item_no:28,
             img_src:'28_.jpg', 
             sub_title:['"온종합병원 호스피스 완화의료병동은 이렇게 운영 됩니다."', '호스피스 완화의료에 대한 오해와 진실'], 
             ...
             sub_context4: ['건강보험이 적용되어 암환자는 본인 부담 5%만 적용됩니다.', '다만, 상급병실료나 특진비 등 비급여 항목은 일부의 비용을 부담할 수 있습니다.'] ,
        ...
        {cate_no:0, 
            item_no:29,
             ...
             sub_context3:['주요 진료 분야는 만성 폐쇄성 폐질환, 기관지 천식, 폐암, 폐렴, 폐결핵, 만성기침, 기관지 확장증, 간질성 폐 질환, 호흡부전, 흉막 질환(기흉, 흉막염, 흉수, 농흉), 식도암, 종격동 종양, 다한증, 오목가슴, 기관 협착 등이며 폐암 진단 시 정기적이고 지속적인 관리를 해드립니다. 저희 호흡기센터 의료진 모두는 환자분들 편에 서서 여러분의 고통을 해결해 드리기 위해 최선을 다할 것으로 약속드립니다.'],
             sub_context2:['호흡기센터는 호흡기내과와 흉부외과로 구서오디어 있어 질병의 정확한 진단, 치료 및 수술까지 빠르고 정확하게 진료할 수 있습니다.', '또한 관련 진료과와 협진을 통해 여러 분야의 전문의들이 모여 환자 중심의 진료를 받을 수 있습니다.'],
             sub_context1: ['우리 사회의 고령화 추세가 높아지면서 호흡기계 중증 질환자의 수가 급격하게 증가하고 있습니다.','이처럼 호흡기계 질환자의 증가에 따라 효율적인 진료를 위해 호흡기센터를 개설, 운영하고 있습니다.'] },
    ]
]
...
const CENT_TITLE = [
    [
        ...
        {cate_no:0, item_no:26, title:'폐암수술센터'},
...
const HOSPI_TITLE = [
    [
        ...
        {cate_no:0, item_no:24, title:'폐암수술센터'},
